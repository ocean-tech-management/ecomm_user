  ...
  <view class="flex-page">
    <view class="search-bar">
      <label class="search-label" for="search">
        ...
        <input id="search" class="search-input" type="text" :value="searchWord" placeholder="搜索关键字"
          placeholder-class="search-input-placeholder" @input="updateSearchWord" @confirm="confirmKeyword" />
      </label>
...
export default {
  ...
  onLoad(options) {
    ...
    if(options.code) this.category_code = options.code;
    if(options.name) {
  ...
  methods: {
    getList() {
      ...
      this.$sget('/goods/list', params, res => {
